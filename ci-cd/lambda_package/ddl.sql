...
COMMENT ON DATABASE petstore IS 'This database is used for managing the Petstore application data, including pets, users, orders, and other related entities.';
